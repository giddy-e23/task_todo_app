...
const UserCollectionSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'syncStatus': PropertySchema(
      ...
      name: r'syncStatus',
      type: IsarType.string,
      enumMap: _UserCollectionsyncStatusEnumValueMap,
    ),
...
UserCollection _userCollectionDeserialize(
  ...
  object.emailVerifiedAt = reader.readDateTimeOrNull(offsets[2]);
  ...
  object.profilePictureUrl = reader.readStringOrNull(offsets[7]);
  object.serverId = reader.readString(offsets[8]);
  object.syncStatus = _UserCollectionsyncStatusValueEnumMap[
...
P _userCollectionDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 8:
      return (reader.readString(offset)) as P;
    case 9:
      return (_UserCollectionsyncStatusValueEnumMap[
...
const _UserCollectionsyncStatusEnumValueMap = {
  r'synced': r'synced',
  r'pending': r'pending',
  r'conflict': r'conflict',
};
const _UserCollectionsyncStatusValueEnumMap = {
...
extension UserCollectionByIndex on IsarCollection<UserCollection> {
  ...
  List<Id> putAllByEmailSync(List<UserCollection> objects,
      {bool saveLinks = true}) {
...
extension UserCollectionQueryFilter
  ...
  QueryBuilder<UserCollection, UserCollection, QAfterFilterCondition>
      emailVerifiedAtEqualTo(DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'emailVerifiedAt',
        value: value,
...
extension UserCollectionQueryWhereDistinct
  ...
  QueryBuilder<UserCollection, UserCollection, QDistinct> distinctBySyncStatus(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserCollectionQueryProperty
  ...
  QueryBuilder<UserCollection, SyncStatus, QQueryOperations>
      syncStatusProperty() {
    return QueryBuilder.apply(this, (query) {
